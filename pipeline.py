    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            #    wget_args.append('https://zowa.app/threads/'+item_value)
                ...
                wget_args.extend(['--warc-header', 'zowa-asset-url: '+url])
...
project = Project(
    ...
    project_html='''
        ...
        <h2>ZOWA <span class="links"><a href="https://zowa.app/">Website</a> &middot; <a href="http://tracker.archiveteam.org/zowa/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/ZOWA">Wiki</a></span></h2>
        <p>Archiving ZOWA.</p>
    '''
)
